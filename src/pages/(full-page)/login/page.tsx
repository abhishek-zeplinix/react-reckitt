                    ...
                    >
                        ...
                        <div>
                            ...
                            <div className="flex align-items-center justify-content-between mb-2">
                                ...
                                <Link to="/forgot-password" className="font-bold no-underline ml-2 text-pink-500 text-right cursor-pointer">
                            ...
                            <div className="flex align-items-center justify-content-center mb-6 mt-3 ">
                                <Link to="/forgot-password" className="font-medium no-underline ml-2  text-center cursor-pointer">
